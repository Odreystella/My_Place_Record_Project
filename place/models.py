...
class Place(BaseField):
    ...
    author = models.OneToOneField(User, on_delete=models.SET_NULL, null=True, blank=True, related_name='place')
    name = models.CharField(max_length=64)
    ...
    like_comments = models.ManyToManyField(User, blank=True, related_name='place')
